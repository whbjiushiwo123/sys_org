 ...
 * 
 */
package com.whb.sys.org.basic.dao;
...
//	}
	...
	public void updateByHql(String hql, Map<String, Object> body) {
		Query query = getSession().createQuery(hql);
		setParameterByKey(query, body);
		query.executeUpdate();
	}
	
	public void setParameterByKey(Query query, Map<String, Object> body) {
		for(String key:body.keySet()){
			query.setParameter(key, body.get(key));
		}
	}
	...
	public Object loadBySn(String sn,String clz) {
		...
		Object[] param=new Object[]{sn};
		return this.queryObject(hql, param);
	}
