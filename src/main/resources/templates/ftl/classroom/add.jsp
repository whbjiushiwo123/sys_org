...
<sf:form modelAttribute="classroom" id="adminForm" method="post">
	...
	<thead>
	 <tr>
	  ...
	  <tr>
	    <td colspan="2" class="left">班级添加<span class="em">[父组织-->${parent.name }]</span><input type="hidden" name="pid" value="${parent.id }"/></td>
	  </tr>
	</thead>
	<tbody>
		<tr>
		...
		<tr>
			<td colspan="2" class="center"><input type="submit" value="添加班级"/></td>
		</tr>
	 </tbody>
	</table>
	</sf:form>
